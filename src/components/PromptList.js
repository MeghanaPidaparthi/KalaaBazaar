...
import prompts from './PromptList'; // Import the prompts from PromptList.js
...
const Kalamitra = () => {
  ...
  const generateResponse = (userMessage) => {
    const promptEntry = prompts.find((p) => p.question === userMessage);
    const response = promptEntry ? promptEntry.response : "I'm not sure how to answer that, but I'll try to learn!";
    setTimeout(() => {
